            ...
            <div class="sb-slick-slider" data-slick-setting='{
                    ...
                    <div class="container">
                        <div class="home-content text-center text-sm-left position-relative">
                            <div class="hero-partial-image image-right">
                                <img src="image/bg-images/klee6.png" alt="">
                            </div>
                            <div class="row no-gutters">
                                <div class="col-lg-6 col-xl-7 col-md-6 col-sm-7">
                                    <div class="home-content-inner content-left-side">
                                        <h1>Genshin Impact<br>
                                            </h1>
                                        <h3>Klee - Mặt trời tàn bạo</h3><br>
										<h5>Một trong những câu chuyện về việc <br> san phẳng Mondstadt của cô bé Klee?</h5>
                ...
                <div class="single-slide bg-shade-whisper  ">
                    <div class="container">
                        <div class="home-content text-center text-sm-left position-relative">
                            <div class="hero-partial-image image-right">
                            <img src="image/bg-images/escanor.png" alt=""> 
                            </div>
                            <div class="row no-gutters ">
                                <div class="col-xl-6 col-md-6 col-sm-7">
                                    <div class="home-content-inner content-left-side">
                                        <h1> Escanor<br>
                                            The One</h1>
                                        <h5>Ta là con người, nhưng ta đứng trên mọi chủng tộc.</h5>
                                        <a href="shop-grid.html" class="btn btn-outlined--primary">
                                            50.000đ Mua ngay!
                                        </a>
                                    </div>
